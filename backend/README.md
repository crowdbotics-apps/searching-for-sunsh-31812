...
## Project Structure
    ...
    ├── searching_for_sunsh_31812  # Django project configurations
...
1. Clone this repo and `cd searching_for_sunsh_31812`
...
2. Clone this repo and `cd searching_for_sunsh_31812`
